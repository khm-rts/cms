...
// If page-id or id is not defined in URL params, or the value is empty, show alert
if ( !isset($_GET['page-id']) || empty($_GET['page-id']) || !isset($_GET['id']) || empty($_GET['id']) )
{
...
else
{
	...
	<div class="card">
		...
		<div class="card-body">
			<form method="post" data-page="<?php echo $view_file ?>" data-params="page-id=<?php echo $page_id ?>&id=<?php echo $id ?>">
				<?php
				// Get the page from the Database
				$query	=
					"SELECT 
